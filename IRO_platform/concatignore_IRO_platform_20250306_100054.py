<issue to solve>
We need detailed logging both for the front-end and the back-end. We need a separate log file each time we run the app. this log file should be datatime stamped
