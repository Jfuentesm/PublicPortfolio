<goal>
create a targeted sprint backlog for developing this solution locally at first, using Docker Compose.
We need a plan that will get allow us to develop locally, before we move to AWS.
