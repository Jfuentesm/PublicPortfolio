...
[+] Running 5/5
 ✔ Container iro_platform-worker-1  Removed                                             2.2s 
 ✔ Container iro_platform-web-1     Removed                                            10.4s 
 ✔ Container iro_platform-redis-1   Removed                                             0.2s 
 ✔ Container iro_platform-db-1      Removed                                             0.3s 
 ✔ Network iro_platform_default     Removed                                             0.3s 
Removing postgres volume to ensure a fresh database...
iro_platform_postgres_data
Building Docker images...
[+] Building 36.7s (20/24)                                              docker:desktop-linux
 => [worker internal] load build definition from Dockerfile                             0.0s
 => => transferring dockerfile: 927B                                                    0.0s
 => [web internal] load build definition from Dockerfile                                0.0s
 => => transferring dockerfile: 927B                                                    0.0s
 => [worker internal] load metadata for docker.io/library/python:3.11-slim              0.4s
 => [web auth] library/python:pull token for registry-1.docker.io                       0.0s
 => [worker internal] load .dockerignore                                                0.0s
 => => transferring context: 2B                                                         0.0s
 => [web internal] load .dockerignore                                                   0.0s
 => => transferring context: 2B                                                         0.0s
 => [web 1/8] FROM docker.io/library/python:3.11-slim@sha256:614c8691ab74150465ec91233  0.0s
 => => resolve docker.io/library/python:3.11-slim@sha256:614c8691ab74150465ec9123378cd  0.0s
 => [web internal] load build context                                                   0.8s
 => => transferring context: 1.24MB                                                     0.8s
 => [worker internal] load build context                                                0.8s
 => => transferring context: 1.24MB                                                     0.8s
 => CACHED [web 2/8] RUN apt-get update     && apt-get install -y postgresql-client     0.0s
 ...
 => [worker 7/8] COPY . /app/                                                           4.8s
 => [worker 8/8] RUN chown -R appuser:appuser /app                                     12.3s
 => [worker] exporting to image                                                        17.7s
 => => exporting layers                                                                 7.2s
 => => exporting manifest sha256:5110249c93f6ce2e2e90ddaaf268fcc3186fb2cc875c96e66ef18  0.0s
 => => exporting config sha256:6aaa9230d2c1e4379643092698b67d714f81ec85fd6bbbcb6165b22  0.0s
 => => exporting attestation manifest sha256:3d9085d9e2240d4360531cfb68527a31d3827ccd7  0.0s
 => => exporting manifest list sha256:7b8af817c44caa473c5fb5dd8c79399822c667cf15a9c185  0.0s
 => => naming to docker.io/library/iro_platform-worker:latest                           0.0s
 => => unpacking to docker.io/library/iro_platform-worker:latest                       10.3s
 => [web] exporting to image                                                           17.7s
 => => exporting layers                                                                 7.2s
 => => exporting manifest sha256:9ba4a5c4e7fdacc4be6523b1c0f121db1ba45a011a24fe5924eb7  0.0s
 => => exporting config sha256:0743951cb885f256ca0fb636be814fc88c008392514c4138cf0f3a4  0.0s
 => => exporting attestation manifest sha256:2adda4a54148a8c9e0cc475358aeb731f27cd5f4c  0.0s
 => => exporting manifest list sha256:f839356785f2c7106659eb4fab441a2622eed47cefbee3b3  0.0s
 => => naming to docker.io/library/iro_platform-web:latest                              0.0s
 => => unpacking to docker.io/library/iro_platform-web:latest                          10.3s
...
[+] Running 6/6
 ✔ Network iro_platform_default         Created                                         0.3s 
 ✔ Volume "iro_platform_postgres_data"  Create...                                       0.0s 
 ✔ Container iro_platform-db-1          Healthy                                         8.7s 
 ✔ Container iro_platform-redis-1       Healthy                                         8.7s 
 ✔ Container iro_platform-web-1         Started                                         6.4s 
 ✔ Container iro_platform-worker-1      Started                                         6.4s 
...
Current schema before assessment creation: public
Assessment "First Time Assessment" already exists for tenant tenant1. Using the existing assessment.
Assessment "Annual Refresh" already exists for tenant tenant1. Using the existing assessment.
...
Current schema before assessment creation: public
Assessment "First Time Assessment" already exists for tenant tenant2. Using the existing assessment.
Assessment "Annual Refresh" already exists for tenant tenant2. Using the existing assessment.
Current schema before IRO creation: public
...
redis-1   | 1:C 27 Feb 2025 07:26:29.724 * oO0OoO0OoO0Oo Redis is starting oO0OoO0OoO0Oo
redis-1   | 1:C 27 Feb 2025 07:26:29.724 * Redis version=7.4.2, bits=64, commit=00000000, modified=0, pid=1, just started
db-1      | The files belonging to this database system will be owned by user "postgres".
worker-1  |  
worker-1  |  -------------- celery@40b5008c52e9 v5.2.7 (dawn-chorus)
worker-1  | --- ***** ----- 
worker-1  | -- ******* ---- Linux-6.12.5-linuxkit-aarch64-with-glibc2.36 2025-02-27 07:26:37
worker-1  | - *** --- * --- 
worker-1  | - ** ---------- [config]
db-1      | This user must also own the server process.
db-1      | 
worker-1  | - ** ---------- .> app:         core:0xffff9bcb4f50
...
worker-1  | 
worker-1  | [2025-02-27 07:26:37,379: INFO/MainProcess] Connected to redis://redis:6379/0
worker-1  | [2025-02-27 07:26:37,388: INFO/MainProcess] mingle: searching for neighbors
worker-1  | [2025-02-27 07:26:38,402: INFO/MainProcess] mingle: all alone
worker-1  | [2025-02-27 07:26:38,414: WARNING/MainProcess] /usr/local/lib/python3.11/site-packages/celery/fixups/django.py:203: UserWarning: Using settings.DEBUG leads to a memory
...
redis-1   | 1:C 27 Feb 2025 07:26:29.724 # Warning: no config file specified, using the default config. In order to specify a config file use redis-server /path/to/redis.conf
redis-1   | 1:M 27 Feb 2025 07:26:29.724 * monotonic clock: POSIX clock_gettime
redis-1   | 1:M 27 Feb 2025 07:26:29.726 * Running mode=standalone, port=6379.
redis-1   | 1:M 27 Feb 2025 07:26:29.726 * Server initialized
redis-1   | 1:M 27 Feb 2025 07:26:29.726 * Ready to accept connections tcp
worker-1  | [2025-02-27 07:26:38,414: INFO/MainProcess] celery@40b5008c52e9 ready.
db-1      | 
...
web-1     |   Applying contenttypes.0001_initial...
web-1     |  OK
web-1     |   Applying auth.0001_initial...
web-1     |  OK
web-1     |   Applying admin.0001_initial...
web-1     |  OK
...
db-1      | 
web-1     |   Applying admin.0002_logentry_remove_auto_add...
web-1     |  OK
db-1      | --auth-local and --auth-host, the next time you run initdb.
web-1     |   Applying admin.0003_logentry_add_action_flag_choices...
web-1     |  OK
db-1      | 
...
db-1      | 
db-1      | waiting for server to start....2025-02-27 07:26:30.814 UTC [48] LOG:  starting PostgreSQL 14.17 (Debian 14.17-1.pgdg120+1) on aarch64-unknown-linux-gnu, compiled by gcc (Debian 12.2.0-14) 12.2.0, 64-bit
db-1      | 2025-02-27 07:26:30.815 UTC [48] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
db-1      | 2025-02-27 07:26:30.817 UTC [49] LOG:  database system was shut down at 2025-02-27 07:26:30 UTC
db-1      | 2025-02-27 07:26:30.821 UTC [48] LOG:  database system is ready to accept connections
db-1      |  done
db-1      | server started
web-1     |   Applying tenants.0001_initial...
web-1     |  OK
web-1     |   Applying assessments.0001_initial...
web-1     |  OK
web-1     |   Applying assessments.0002_assessment_tenant...
web-1     |  OK
...
db-1      | 
db-1      | 
db-1      | waiting for server to shut down...2025-02-27 07:26:31.093 UTC [48] LOG:  received fast shutdown request
db-1      | .2025-02-27 07:26:31.095 UTC [48] LOG:  aborting any active transactions
web-1     |   Applying assessments.0003_alter_assessment_tenant...
web-1     |  OK
db-1      | 2025-02-27 07:26:31.097 UTC [48] LOG:  background worker "logical replication launcher" (PID 55) exited with exit code 1
db-1      | 2025-02-27 07:26:31.097 UTC [50] LOG:  shutting down
db-1      | 2025-02-27 07:26:31.105 UTC [48] LOG:  database system is shut down
db-1      |  done
db-1      | server stopped
db-1      | 
db-1      | PostgreSQL init process complete; ready for start up.
db-1      | 
db-1      | 2025-02-27 07:26:31.218 UTC [1] LOG:  starting PostgreSQL 14.17 (Debian 14.17-1.pgdg120+1) on aarch64-unknown-linux-gnu, compiled by gcc (Debian 12.2.0-14) 12.2.0, 64-bit
db-1      | 2025-02-27 07:26:31.218 UTC [1] LOG:  listening on IPv4 address "0.0.0.0", port 5432
web-1     |   Applying contenttypes.0002_remove_content_type_name...
db-1      | 2025-02-27 07:26:31.218 UTC [1] LOG:  listening on IPv6 address "::", port 5432
web-1     |  OK
db-1      | 2025-02-27 07:26:31.220 UTC [1] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
web-1     |   Applying auth.0002_alter_permission_name_max_length...
db-1      | 2025-02-27 07:26:31.224 UTC [65] LOG:  database system was shut down at 2025-02-27 07:26:31 UTC
web-1     |  OK
db-1      | 2025-02-27 07:26:31.234 UTC [1] LOG:  database system is ready to accept connections
web-1     |   Applying auth.0003_alter_user_email_max_length...
web-1     |  OK
web-1     |   Applying auth.0004_alter_user_username_opts...
web-1     |  OK
web-1     |   Applying auth.0005_alter_user_last_login_null...
web-1     |  OK
web-1     |   Applying auth.0006_require_contenttypes_0002...
web-1     |  OK
web-1     |   Applying auth.0007_alter_validators_add_error_messages...
web-1     |  OK
web-1     |   Applying auth.0008_alter_user_username_max_length...
web-1     |  OK
web-1     |   Applying auth.0009_alter_user_last_name_max_length...
web-1     |  OK
web-1     |   Applying auth.0010_alter_group_name_max_length...
web-1     |  OK
web-1     |   Applying auth.0011_update_proxy_permissions...
web-1     |  OK
web-1     |   Applying auth.0012_alter_user_first_name_max_length...
web-1     |  OK
web-1     |   Applying guardian.0001_initial...
web-1     |  OK
web-1     |   Applying guardian.0002_generic_permissions_index...
web-1     |  OK
web-1     |   Applying sessions.0001_initial...
web-1     |  OK
web-1     | === Starting migration
web-1     | Operations to perform:
web-1     |   Apply all migrations: admin, assessments, auth, contenttypes, guardian, sessions, tenants
...
web-1     |   Applying sessions.0001_initial...
web-1     |  OK
web-1     | Successfully created tenant "default" with domain "localhost".
web-1     | === Starting migration
web-1     | Operations to perform:
web-1     |   Apply all migrations: admin, assessments, auth, contenttypes, guardian, sessions, tenants
web-1     | Running migrations:
...
web-1     |   Applying sessions.0001_initial...
web-1     |  OK
web-1     | Created tenant "tenant1" with domain "tenant1.localhost".
web-1     | Current schema before assessment creation: public
web-1     | Created assessment "First Time Assessment" for tenant tenant1.
web-1     | Created assessment "Annual Refresh" for tenant tenant1.
web-1     | Current schema before IRO creation: public
web-1     | Found 0 existing IROs for tenant tenant1
web-1     | Current schema before creating IRO #1: tenant_tenant1
web-1     | Created IRO with ID: 1, type: Risk in schema: tenant_tenant1
web-1     | Created RiskOppAssessment with ID: 1 for Risk type IRO
web-1     | Created IRO #1 (Climate Transition Risk) of type Risk and its appropriate assessment for tenant: tenant1
web-1     | Current schema before creating IRO #2: tenant_tenant1
web-1     | Created IRO with ID: 2, type: Opportunity in schema: tenant_tenant1
web-1     | Created RiskOppAssessment with ID: 2 for Opportunity type IRO
web-1     | Created IRO #2 (Sustainable Product Development) of type Opportunity and its appropriate assessment for tenant: tenant1
web-1     | Current schema before creating IRO #3: tenant_tenant1
web-1     | Created IRO with ID: 3, type: Impact in schema: tenant_tenant1
web-1     | Created ImpactAssessment with ID: 1 for Impact type IRO
web-1     | Created IRO #3 (Carbon Emissions) of type Impact and its appropriate assessment for tenant: tenant1
web-1     | Current schema before creating IRO #4: tenant_tenant1
web-1     | Created IRO with ID: 4, type: Risk in schema: tenant_tenant1
web-1     | Created RiskOppAssessment with ID: 3 for Risk type IRO
web-1     | Created IRO #4 (Water Scarcity Risk) of type Risk and its appropriate assessment for tenant: tenant1
web-1     | Current schema before creating IRO #5: tenant_tenant1
web-1     | Created IRO with ID: 5, type: Opportunity in schema: tenant_tenant1
web-1     | Created RiskOppAssessment with ID: 4 for Opportunity type IRO
web-1     | Created IRO #5 (Energy Efficiency) of type Opportunity and its appropriate assessment for tenant: tenant1
web-1     | === Starting migration
web-1     | Operations to perform:
web-1     |   Apply all migrations: admin, assessments, auth, contenttypes, guardian, sessions, tenants
web-1     | Running migrations:
...
web-1     |   Applying sessions.0001_initial...
web-1     |  OK
web-1     | Created tenant "tenant2" with domain "tenant2.localhost".
web-1     | Current schema before assessment creation: public
web-1     | Created assessment "First Time Assessment" for tenant tenant2.
web-1     | Created assessment "Annual Refresh" for tenant tenant2.
web-1     | Current schema before IRO creation: public
web-1     | Found 0 existing IROs for tenant tenant2
web-1     | Current schema before creating IRO #1: tenant_tenant2
web-1     | Created IRO with ID: 1, type: Risk in schema: tenant_tenant2
web-1     | Created RiskOppAssessment with ID: 1 for Risk type IRO
web-1     | Created IRO #1 (Climate Transition Risk) of type Risk and its appropriate assessment for tenant: tenant2
web-1     | Current schema before creating IRO #2: tenant_tenant2
web-1     | Created IRO with ID: 2, type: Opportunity in schema: tenant_tenant2
web-1     | Created RiskOppAssessment with ID: 2 for Opportunity type IRO
web-1     | Created IRO #2 (Sustainable Product Development) of type Opportunity and its appropriate assessment for tenant: tenant2
web-1     | Current schema before creating IRO #3: tenant_tenant2
web-1     | Created IRO with ID: 3, type: Impact in schema: tenant_tenant2
web-1     | Created ImpactAssessment with ID: 1 for Impact type IRO
web-1     | Created IRO #3 (Carbon Emissions) of type Impact and its appropriate assessment for tenant: tenant2
web-1     | Current schema before creating IRO #4: tenant_tenant2
web-1     | Created IRO with ID: 4, type: Risk in schema: tenant_tenant2
web-1     | Created RiskOppAssessment with ID: 3 for Risk type IRO
web-1     | Created IRO #4 (Water Scarcity Risk) of type Risk and its appropriate assessment for tenant: tenant2
web-1     | Current schema before creating IRO #5: tenant_tenant2
web-1     | Created IRO with ID: 5, type: Opportunity in schema: tenant_tenant2
web-1     | Created RiskOppAssessment with ID: 4 for Opportunity type IRO
web-1     | Created IRO #5 (Energy Efficiency) of type Opportunity and its appropriate assessment for tenant: tenant2
...
web-1     | 
web-1     | 
web-1     | 166 static files copied to '/app/core/static'.
web-1     | [2025-02-27 07:26:47 +0000] [22] [INFO] Starting gunicorn 20.1.0
web-1     | [2025-02-27 07:26:47 +0000] [22] [INFO] Listening at: http://0.0.0.0:8000 (22)
web-1     | [2025-02-27 07:26:47 +0000] [22] [INFO] Using worker: sync
web-1     | [2025-02-27 07:26:47 +0000] [23] [INFO] Booting worker with pid: 23
web-1     | Not Found: /static/js/handsontable-manager.js
web-1     | Not Found: /static/js/handsontable-manager.js
web-1     | Not Found: /static/js/handsontable-manager.js
...
<output instruction>
1) Reflect on 5-7 different possible sources of the problem, distill those down to the most likely root cause 
...
- core/static/js/context_manager.js
- core/static/js/dashboard.js
- core/static/js/handsontable-manager.js
- core/urls.py
- core/views.py
- core/wsgi.py
- docker-compose.yaml
...
<file path='core/static/js/context_manager.js'>
// static/js/context_manager.js
...
<file path='core/static/js/dashboard.js'>
// static/js/dashboard.js
...
<file path='core/static/js/handsontable-manager.js'>
// static/js/handsontable-manager.js
    ...
    fetch('{% url "assessments:iro-data" %}')
        ...
        .then(data => {
            ...
            const columnDefs = [
                ...
                { 
                    ...
                    readOnly: true,
                    className: function(row, col, prop) {
                        const value = data[row]?.impact_score || 0;
                        if (value > 3.5) return 'bg-danger bg-opacity-25';
                        if (value > 2.5) return 'bg-warning bg-opacity-25';
                ...
                { 
                    ...
                    readOnly: true,
                    className: function(row, col, prop) {
                        const value = data[row]?.financial_score || 0;
                        if (value > 3.5) return 'bg-danger bg-opacity-25';
                        if (value > 2.5) return 'bg-warning bg-opacity-25';
                        return 'bg-success bg-opacity-25';
                    }
            ...
            // Update row count
            document.getElementById('iro-count').textContent = data.length;
        ...
        .catch(error => {
            ...
            document.getElementById('iro-table-container').innerHTML = 
                '<div class="alert alert-danger">Error loading IRO data. Please try refreshing the page.</div>';
        });
});
</script>
{% endblock %}
