...
[+] Running 5/5
 ...
 ✔ Container iro_platform-worker-1  Removed                                         2.6s 
...
[+] Building 31.4s (20/24)                                          docker:desktop-linux
 => [worker internal] load build definition from Dockerfile                         0.0s
 => => transferring dockerfile: 927B                                                0.0s
 => [web internal] load build definition from Dockerfile                            0.0s
 => => transferring dockerfile: 927B                                                0.0s
 => [worker internal] load metadata for docker.io/library/python:3.11-slim          0.6s
 => [web auth] library/python:pull token for registry-1.docker.io                   0.0s
 => [web internal] load .dockerignore                                               0.0s
 => => transferring context: 2B                                                     0.0s
 => [worker internal] load .dockerignore                                            0.0s
 => => transferring context: 2B                                                     0.0s
 => [web 1/8] FROM docker.io/library/python:3.11-slim@sha256:614c8691ab74150465ec9  0.0s
 => => resolve docker.io/library/python:3.11-slim@sha256:614c8691ab74150465ec91233  0.0s
 => [web internal] load build context                                               1.8s
 => => transferring context: 1.50MB                                                 1.7s
 => [worker internal] load build context                                            1.8s
 => => transferring context: 1.50MB                                                 1.7s
 => CACHED [web 6/8] RUN pip install --no-cache-dir -r requirements.txt             0.0s
 => CACHED [web 2/8] RUN apt-get update     && apt-get install -y postgresql-clien  0.0s
 ...
 => [web 7/8] COPY . /app/                                                          4.2s
 => [worker 8/8] RUN chown -R appuser:appuser /app                                 12.5s
 => [worker] exporting to image                                                    11.9s
 => => exporting layers                                                             5.9s
 => => exporting manifest sha256:d96248999f806432472b043c213329a89088fad3dbb674b8d  0.0s
 => => exporting config sha256:df53fd31981c54ba634ef53b550255eaa70c32b4708266009e8  0.0s
 => => exporting attestation manifest sha256:4932d5a7d41a7dde8beba52a747c55e417cd7  0.0s
 => => exporting manifest list sha256:b57fae14c37abe8cd54724614e3d619149aab50eff13  0.0s
 => => naming to docker.io/library/iro_platform-worker:latest                       0.0s
 => => unpacking to docker.io/library/iro_platform-worker:latest                    6.0s
 => [web] exporting to image                                                       11.9s
 => => exporting layers                                                             5.9s
 => => exporting manifest sha256:666a7209f462747751b5e4414e66d88fffb83f806805fcdff  0.0s
 => => exporting config sha256:cd992af5ae30292a8c0c8dc121da21b6b683066973ada63fd61  0.0s
 => => exporting attestation manifest sha256:a45b7811027cceb4891b986efd606418f7d00  0.0s
 => => exporting manifest list sha256:c9fe2d20c01a8a27af189fd820199d2715821e75860f  0.0s
 => => naming to docker.io/library/iro_platform-web:latest                          0.0s
 => => unpacking to docker.io/library/iro_platform-web:latest                       6.0s
...
[+] Running 6/6
 ✔ Network iro_platform_default         Created                                     0.2s 
 ✔ Volume "iro_platform_postgres_data"  Cr...                                       0.0s 
 ✔ Container iro_platform-redis-1       Healthy                                     7.1s 
 ✔ Container iro_platform-db-1          Healthy                                     7.1s 
 ✔ Container iro_platform-worker-1      Starte...                                   6.5s 
 ✔ Container iro_platform-web-1         Started                                     6.5s 
...
db-1      | 
db-1      | waiting for server to start....2025-02-27 04:42:11.565 UTC [48] LOG:  starting PostgreSQL 14.17 (Debian 14.17-1.pgdg120+1) on aarch64-unknown-linux-gnu, compiled by gcc (Debian 12.2.0-14) 12.2.0, 64-bit
db-1      | 2025-02-27 04:42:11.566 UTC [48] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
db-1      | 2025-02-27 04:42:11.570 UTC [49] LOG:  database system was shut down at 2025-02-27 04:42:11 UTC
db-1      | 2025-02-27 04:42:11.574 UTC [48] LOG:  database system is ready to accept connections
db-1      |  done
db-1      | server started
...
db-1      | 
db-1      | 
db-1      | waiting for server to shut down...2025-02-27 04:42:11.829 UTC [48] LOG:  received fast shutdown request
db-1      | .2025-02-27 04:42:11.830 UTC [48] LOG:  aborting any active transactions
db-1      | 2025-02-27 04:42:11.831 UTC [48] LOG:  background worker "logical replication launcher" (PID 55) exited with exit code 1
db-1      | 2025-02-27 04:42:11.832 UTC [50] LOG:  shutting down
db-1      | 2025-02-27 04:42:11.840 UTC [48] LOG:  database system is shut down
db-1      |  done
db-1      | server stopped
db-1      | 
db-1      | PostgreSQL init process complete; ready for start up.
db-1      | 
db-1      | 2025-02-27 04:42:12.035 UTC [1] LOG:  starting PostgreSQL 14.17 (Debian 14.17-1.pgdg120+1) on aarch64-unknown-linux-gnu, compiled by gcc (Debian 12.2.0-14) 12.2.0, 64-bit
db-1      | 2025-02-27 04:42:12.035 UTC [1] LOG:  listening on IPv4 address "0.0.0.0", port 5432
db-1      | 2025-02-27 04:42:12.035 UTC [1] LOG:  listening on IPv6 address "::", port 5432
db-1      | 2025-02-27 04:42:12.037 UTC [1] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
db-1      | 2025-02-27 04:42:12.040 UTC [65] LOG:  database system was shut down at 2025-02-27 04:42:11 UTC
db-1      | 2025-02-27 04:42:12.044 UTC [1] LOG:  database system is ready to accept connections
redis-1   | 1:C 27 Feb 2025 04:42:10.430 * oO0OoO0OoO0Oo Redis is starting oO0OoO0OoO0Oo
redis-1   | 1:C 27 Feb 2025 04:42:10.430 * Redis version=7.4.2, bits=64, commit=00000000, modified=0, pid=1, just started
redis-1   | 1:C 27 Feb 2025 04:42:10.430 # Warning: no config file specified, using the default config. In order to specify a config file use redis-server /path/to/redis.conf
redis-1   | 1:M 27 Feb 2025 04:42:10.431 * monotonic clock: POSIX clock_gettime
redis-1   | 1:M 27 Feb 2025 04:42:10.432 * Running mode=standalone, port=6379.
redis-1   | 1:M 27 Feb 2025 04:42:10.433 * Server initialized
redis-1   | 1:M 27 Feb 2025 04:42:10.433 * Ready to accept connections tcp
worker-1  |  
worker-1  |  -------------- celery@d7ace60a5463 v5.2.7 (dawn-chorus)
worker-1  | --- ***** ----- 
worker-1  | -- ******* ---- Linux-6.12.5-linuxkit-aarch64-with-glibc2.36 2025-02-27 04:42:17
worker-1  | - *** --- * --- 
worker-1  | - ** ---------- [config]
worker-1  | - ** ---------- .> app:         core:0xffff7fbb5a50
...
worker-1  | 
worker-1  | [2025-02-27 04:42:17,714: INFO/MainProcess] Connected to redis://redis:6379/0
worker-1  | [2025-02-27 04:42:17,720: INFO/MainProcess] mingle: searching for neighbors
worker-1  | [2025-02-27 04:42:18,730: INFO/MainProcess] mingle: all alone
worker-1  | [2025-02-27 04:42:18,755: WARNING/MainProcess] /usr/local/lib/python3.11/site-packages/celery/fixups/django.py:203: UserWarning: Using settings.DEBUG leads to a memory
...
worker-1  | 
worker-1  | [2025-02-27 04:42:18,755: INFO/MainProcess] celery@d7ace60a5463 ready.
...
web-1     | [2025-02-27 04:42:27 +0000] [23] [INFO] Starting gunicorn 20.1.0
web-1     | [2025-02-27 04:42:27 +0000] [23] [INFO] Listening at: http://0.0.0.0:8000 (23)
web-1     | [2025-02-27 04:42:27 +0000] [23] [INFO] Using worker: sync
web-1     | [2025-02-27 04:42:27 +0000] [24] [INFO] Booting worker with pid: 24
