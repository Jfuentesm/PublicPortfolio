<goal>
please audit the log, is everything working as expected? if not, what is missing?
...
[+] Running 5/5
 ✔ Container iro_platform-worker-1  Remo...                                  23.8s 
 ✔ Container iro_platform-web-1     Removed                                  23.7s 
 ✔ Container iro_platform-db-1      Removed                                   2.9s 
 ✔ Container iro_platform-redis-1   Remov...                                  2.5s 
 ✔ Network iro_platform_default     Removed                                   0.6s 
[+] Building 40.4s (18/21)                                                    docker:desktop-linux
 => [web internal] load build definition from Dockerfile                                      0.1s
 => => transferring dockerfile: 708B                                                          0.1s
 => [worker internal] load build definition from Dockerfile                                   0.1s
 => => transferring dockerfile: 708B                                                          0.1s
 => [web internal] load metadata for docker.io/library/python:3.11-slim                       1.0s
 => [web auth] library/python:pull token for registry-1.docker.io                             0.0s
 => [web internal] load .dockerignore                                                         0.0s
 => => transferring context: 2B                                                               0.0s
 => [worker internal] load .dockerignore                                                      0.0s
 => => transferring context: 2B                                                               0.0s
 => [worker 1/6] FROM docker.io/library/python:3.11-slim@sha256:614c8691ab74150465ec9123378c  0.2s
 => => resolve docker.io/library/python:3.11-slim@sha256:614c8691ab74150465ec9123378cd4dde7a  0.2s
 => [web internal] load build context                                                         3.2s
 => => transferring context: 1.56MB                                                           2.7s
 => [worker internal] load build context                                                      3.2s
 => => transferring context: 1.56MB                                                           2.7s
 => CACHED [web 2/6] RUN apt-get update     && apt-get install -y postgresql-client     && r  0.0s
 ...
 => [worker 6/6] COPY . /app/                                                                 9.9s
 => [web] exporting to image                                                                 25.7s
 => => exporting layers                                                                      10.2s
 => => exporting manifest sha256:2274c55e36f71b71e88e169e39a92181849ffb43ccb5ef5e0ecea2081da  0.1s
 => => exporting config sha256:1ff9964f57554f90e5f866f109c3e4587ff50cc4a0b5595d9a899ec47ab64  0.0s
 => => exporting attestation manifest sha256:97614c1bee425448dfa65131be9e1a5b2d10f92ce9a7d08  0.0s
 => => exporting manifest list sha256:f1955718887c12c0e75e40032861f4ca69b1f44ad0e87047a5ddf3  0.0s
 => => naming to docker.io/library/iro_platform-web:latest                                    0.0s
 => => unpacking to docker.io/library/iro_platform-web:latest                                15.0s
 => [worker] exporting to image                                                              25.7s
 => => exporting layers                                                                      10.2s
 => => exporting manifest sha256:e42941878af030b15be39b3bf87f4b9289c1f5601282c9a0ae2515d6016  0.0s
 => => exporting config sha256:5ea0f0151bef637783a366c4304e5bb1f26ca84e8ad1ba3020576089cce84  0.0s
 => => exporting attestation manifest sha256:1e3e3f774752fe30658e210cbe058afd104de82aed97f3d  0.0s
 => => exporting manifest list sha256:55cbc277c33ffa269b6ec0627830bf3aab94a29509be795a90a95b  0.0s
 => => naming to docker.io/library/iro_platform-worker:latest                                 0.0s
 => => unpacking to docker.io/library/iro_platform-worker:latest                             15.1s
...
[+] Running 5/5
 ✔ Network iro_platform_default     Created                                                   0.7s 
 ✔ Container iro_platform-db-1      Healthy                                                  13.3s 
 ✔ Container iro_platform-redis-1   Healthy                                                  12.2s 
 ✔ Container iro_platform-worker-1  Started                                                  10.5s 
 ✔ Container iro_platform-web-1     Started                                                  10.5s 
...
Found 0 existing IROs for tenant tenant1
Current schema before creating IRO #1: tenant_tenant1
Created IRO with ID: 2 in schema: tenant_tenant1
Created ImpactAssessment with ID: 2
Created RiskOppAssessment with ID: 1
Created IRO #2 and its assessments for tenant: tenant1
Current schema before creating IRO #2: tenant_tenant1
Created IRO with ID: 3 in schema: tenant_tenant1
Created ImpactAssessment with ID: 3
Created RiskOppAssessment with ID: 2
Created IRO #3 and its assessments for tenant: tenant1
Current schema before creating IRO #3: tenant_tenant1
Created IRO with ID: 4 in schema: tenant_tenant1
Created ImpactAssessment with ID: 4
Created RiskOppAssessment with ID: 3
Created IRO #4 and its assessments for tenant: tenant1
Current schema before creating IRO #4: tenant_tenant1
Created IRO with ID: 5 in schema: tenant_tenant1
Created ImpactAssessment with ID: 5
Created RiskOppAssessment with ID: 4
Created IRO #5 and its assessments for tenant: tenant1
Current schema before creating IRO #5: tenant_tenant1
Created IRO with ID: 6 in schema: tenant_tenant1
Created ImpactAssessment with ID: 6
Created RiskOppAssessment with ID: 5
Created IRO #6 and its assessments for tenant: tenant1
Current schema after all IRO creation: public
=== Starting migration
Operations to perform:
  Apply all migrations: admin, assessments, auth, contenttypes, guardian, sessions, tenants
Running migrations:
 ...
 OK
  Applying assessments.0001_initial...
 OK
 ...
 OK
  Applying guardian.0001_initial...
 OK
  Applying guardian.0002_generic_permissions_index...
 OK
  Applying sessions.0001_initial...
 OK
Created tenant "tenant2" with domain "tenant2.localhost".
Current schema before IRO creation: public
Found 0 existing IROs for tenant tenant2
Current schema before creating IRO #1: tenant_tenant2
Created IRO with ID: 1 in schema: tenant_tenant2
Created ImpactAssessment with ID: 1
Created RiskOppAssessment with ID: 1
Created IRO #1 and its assessments for tenant: tenant2
Current schema before creating IRO #2: tenant_tenant2
Created IRO with ID: 2 in schema: tenant_tenant2
Created ImpactAssessment with ID: 2
Created RiskOppAssessment with ID: 2
Created IRO #2 and its assessments for tenant: tenant2
Current schema before creating IRO #3: tenant_tenant2
Created IRO with ID: 3 in schema: tenant_tenant2
Created ImpactAssessment with ID: 3
Created RiskOppAssessment with ID: 3
Created IRO #3 and its assessments for tenant: tenant2
Current schema before creating IRO #4: tenant_tenant2
Created IRO with ID: 4 in schema: tenant_tenant2
Created ImpactAssessment with ID: 4
Created RiskOppAssessment with ID: 4
Created IRO #4 and its assessments for tenant: tenant2
Current schema before creating IRO #5: tenant_tenant2
Created IRO with ID: 5 in schema: tenant_tenant2
Created ImpactAssessment with ID: 5
Created RiskOppAssessment with ID: 5
Created IRO #5 and its assessments for tenant: tenant2
Current schema after all IRO creation: public
Tailing logs. Press Ctrl+C to stop.
redis-1   | 1:C 26 Feb 2025 10:12:09.037 * oO0OoO0OoO0Oo Redis is starting oO0OoO0OoO0Oo
redis-1   | 1:C 26 Feb 2025 10:12:09.039 * Redis version=7.4.2, bits=64, commit=00000000, modified=0, pid=1, just started
redis-1   | 1:C 26 Feb 2025 10:12:09.039 # Warning: no config file specified, using the default config. In order to specify a config file use redis-server /path/to/redis.conf
redis-1   | 1:M 26 Feb 2025 10:12:09.040 * monotonic clock: POSIX clock_gettime
redis-1   | 1:M 26 Feb 2025 10:12:09.089 * Running mode=standalone, port=6379.
redis-1   | 1:M 26 Feb 2025 10:12:09.112 * Server initialized
redis-1   | 1:M 26 Feb 2025 10:12:09.123 * Ready to accept connections tcp
...
db-1      | 
db-1      | 2025-02-26 10:12:11.534 UTC [1] LOG:  starting PostgreSQL 14.16 (Debian 14.16-1.pgdg120+1) on aarch64-unknown-linux-gnu, compiled by gcc (Debian 12.2.0-14) 12.2.0, 64-bit
db-1      | 2025-02-26 10:12:11.552 UTC [1] LOG:  listening on IPv4 address "0.0.0.0", port 5432
db-1      | 2025-02-26 10:12:11.555 UTC [1] LOG:  listening on IPv6 address "::", port 5432
worker-1  | 
worker-1  |   warnings.warn(SecurityWarning(ROOT_DISCOURAGED.format(
worker-1  |  
db-1      | 2025-02-26 10:12:11.572 UTC [1] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
db-1      | 2025-02-26 10:12:11.623 UTC [26] LOG:  database system was shut down at 2025-02-26 10:11:13 UTC
db-1      | 2025-02-26 10:12:11.806 UTC [1] LOG:  database system is ready to accept connections
web-1     | No changes detected in app 'tenants'
web-1     | No changes detected
web-1     | === Starting migration
worker-1  |  -------------- celery@e3d5adc0b9f3 v5.2.7 (dawn-chorus)
worker-1  | --- ***** ----- 
...
worker-1  | -- ******* ---- Linux-6.12.5-linuxkit-aarch64-with-glibc2.36 2025-02-26 10:12:17
worker-1  | - *** --- * --- 
worker-1  | - ** ---------- [config]
...
web-1     | Operations to perform:
web-1     |   Apply all migrations: admin, assessments, auth, contenttypes, guardian, sessions, tenants
worker-1  | - ** ---------- .> app:         core:0xffff83635250
...
worker-1  | 
worker-1  | [2025-02-26 10:12:18,906: INFO/MainProcess] Connected to redis://redis:6379/0
web-1     | Operations to perform:
web-1     |   Apply all migrations: admin, assessments, auth, contenttypes, guardian, sessions, tenants
web-1     | Running migrations:
web-1     |   No migrations to apply.
...
worker-1  | [2025-02-26 10:12:18,936: INFO/MainProcess] mingle: searching for neighbors
worker-1  | [2025-02-26 10:12:19,995: INFO/MainProcess] mingle: all alone
worker-1  | [2025-02-26 10:12:20,058: WARNING/MainProcess] /usr/local/lib/python3.11/site-packages/celery/fixups/django.py:203: UserWarning: Using settings.DEBUG leads to a memory
...
web-1     | sh: 21: docker: not found
web-1     | sh: 23: docker: not found
web-1     | 
web-1     | 162 static files copied to '/app/core/static'.
web-1     | [2025-02-26 10:12:25 +0000] [20] [INFO] Starting gunicorn 20.1.0
worker-1  | 
worker-1  | [2025-02-26 10:12:20,059: INFO/MainProcess] celery@e3d5adc0b9f3 ready.
web-1     | [2025-02-26 10:12:25 +0000] [20] [INFO] Listening at: http://0.0.0.0:8000 (20)
web-1     | [2025-02-26 10:12:25 +0000] [20] [INFO] Using worker: sync
web-1     | [2025-02-26 10:12:25 +0000] [21] [INFO] Booting worker with pid: 21
</log>
  ...
  web:
    ...
    command: >
      sh -c "
        ...
        docker compose exec -T db psql -U dma_user -d dma_db -c \"\\dt tenant_tenant1.*\"
        echo 'Listing tables in tenant_tenant2 schema...'
        docker compose exec -T db psql -U dma_user -d dma_db -c \"\\dt tenant_tenant2.*\"

        # 4) Collect static files so admin CSS/JS are available
