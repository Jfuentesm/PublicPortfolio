<goal>
guide me to move from the current project structure to the "Target Django project file structure", ensuring everthing cobtinues to work

</goal>


<output instruction>
1) Explain steps we need to take (e.g., create new folder called XX under folder YY and place file ZZ)
2) If scripts need to change, give me the COMPLETE UPDATED VERSION of each script that needs to be updated
</output instruction>
...
<Target Django project file structure>
