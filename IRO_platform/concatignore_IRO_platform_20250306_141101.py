<issue to solve>
the 'High Priority IROs' table in the home screen loads correctly. howver, the IROs library table in IROs screen does not load content after I select the context. 

</issue to solve>

<log>
web-1     | Message: 'GET /assessments/iro/data/ - 200 in 70.46ms'
web-1     | Arguments: ()
web-1     | ERROR 2025-03-06 19:08:54,198 Error loading IRO data: {}
web-1     | INFO 2025-03-06 19:08:54,198 POST /api/logs/frontend/ - 200 in 0.4ms
web-1     | --- Logging error ---
web-1     | Traceback (most recent call last):
web-1     |   File "/usr/local/lib/python3.11/logging/__init__.py", line 449, in format
web-1     |     return self._format(record)
web-1     |            ^^^^^^^^^^^^^^^^^^^^
web-1     |   File "/usr/local/lib/python3.11/logging/__init__.py", line 467, in _format
web-1     |     return self._fmt.format(**values)
web-1     |            ^^^^^^^^^^^^^^^^^^^^^^^^^^
web-1     | KeyError: 'tenant'
web-1     | 
web-1     | During handling of the above exception, another exception occurred:
web-1     | 
web-1     | Traceback (most recent call last):
web-1     |   File "/usr/local/lib/python3.11/logging/__init__.py", line 1110, in emit
web-1     |     msg = self.format(record)
web-1     |           ^^^^^^^^^^^^^^^^^^^
web-1     |   File "/usr/local/lib/python3.11/logging/__init__.py", line 953, in format
web-1     |     return fmt.format(record)
web-1     |            ^^^^^^^^^^^^^^^^^^
web-1     |   File "/usr/local/lib/python3.11/logging/__init__.py", line 690, in format
web-1     |     s = self.formatMessage(record)
web-1     |         ^^^^^^^^^^^^^^^^^^^^^^^^^^
web-1     |   File "/usr/local/lib/python3.11/logging/__init__.py", line 659, in formatMessage
web-1     |     return self._style.format(record)
web-1     |            ^^^^^^^^^^^^^^^^^^^^^^^^^^
web-1     |   File "/usr/local/lib/python3.11/logging/__init__.py", line 451, in format
web-1     |     raise ValueError('Formatting field not found in record: %s' % e)
web-1     | ValueError: Formatting field not found in record: 'tenant'
web-1     | Call stack:
web-1     |   File "/usr/local/bin/gunicorn", line 8, in <module>
web-1     |     sys.exit(run())
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/app/wsgiapp.py", line 67, in run
web-1     |     WSGIApplication("%(prog)s [OPTIONS] [APP_MODULE]").run()
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/app/base.py", line 231, in run
web-1     |     super().run()
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/app/base.py", line 72, in run
web-1     |     Arbiter(self).run()
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/arbiter.py", line 202, in run
web-1     |     self.manage_workers()
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/arbiter.py", line 551, in manage_workers
web-1     |     self.spawn_workers()
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/arbiter.py", line 622, in spawn_workers
web-1     |     self.spawn_worker()
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/arbiter.py", line 589, in spawn_worker
web-1     |     worker.init_process()
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/workers/base.py", line 142, in init_process
web-1     |     self.run()
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/workers/sync.py", line 125, in run
web-1     |     self.run_for_one(timeout)
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/workers/sync.py", line 69, in run_for_one
web-1     |     self.accept(listener)
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/workers/sync.py", line 31, in accept
web-1     |     self.handle(listener, client, addr)
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/workers/sync.py", line 136, in handle
web-1     |     self.handle_request(listener, req, client, addr)
web-1     |   File "/usr/local/lib/python3.11/site-packages/gunicorn/workers/sync.py", line 179, in handle_request
web-1     |     respiter = self.wsgi(environ, resp.start_response)
web-1     |   File "/usr/local/lib/python3.11/site-packages/django/core/handlers/wsgi.py", line 134, in __call__
...
web-1     |   File "/usr/local/lib/python3.11/site-packages/django/core/handlers/exception.py", line 55, in inner
web-1     |     response = get_response(request)
web-1     |   File "/usr/local/lib/python3.11/site-packages/whitenoise/middleware.py", line 124, in __call__
web-1     |     return self.get_response(request)
web-1     |   File "/usr/local/lib/python3.11/site-packages/django/core/handlers/exception.py", line 55, in inner
web-1     |     response = get_response(request)
web-1     |   File "/usr/local/lib/python3.11/site-packages/django/utils/deprecation.py", line 134, in __call__
web-1     |     response = response or self.get_response(request)
...
web-1     |   File "/usr/local/lib/python3.11/site-packages/django/core/handlers/exception.py", line 55, in inner
web-1     |     response = get_response(request)
web-1     |   File "/app/core/middleware/context_middleware.py", line 137, in __call__
web-1     |     response = self.get_response(request)
web-1     |   File "/usr/local/lib/python3.11/site-packages/django/core/handlers/exception.py", line 55, in inner
web-1     |     response = get_response(request)
web-1     |   File "/app/core/middleware/logging_middleware.py", line 51, in __call__
web-1     |     request_logger.info(log_message, extra={'log_data': log_data})
web-1     | Message: 'POST /api/logs/frontend/ - 200 in 0.4ms'
web-1     | Arguments: ()
web-1     | INFO 2025-03-06 19:08:58,813 GET /set-context/ - 302 in 2.33ms
web-1     | --- Logging error ---
web-1     | Traceback (most recent call last):
web-1     |   File "/usr/local/lib/python3.11/logging/__init__.py", line 449, in format
web-1     |     return self._format(record)
...
web-1     |   File "/app/core/middleware/logging_middleware.py", line 51, in __call__
web-1     |     request_logger.info(log_message, extra={'log_data': log_data})
web-1     | Message: 'GET /set-context/ - 302 in 2.33ms'
web-1     | Arguments: ()
web-1     | INFO 2025-03-06 19:08:58,887 GET /assessments/iro/ - 200 in 40.64ms
web-1     | --- Logging error ---
web-1     | Traceback (most recent call last):
web-1     |   File "/usr/local/lib/python3.11/logging/__init__.py", line 449, in format
web-1     |     return self._format(record)
...
web-1     |   File "/app/core/middleware/logging_middleware.py", line 51, in __call__
web-1     |     request_logger.info(log_message, extra={'log_data': log_data})
web-1     | Message: 'GET /assessments/iro/ - 200 in 40.64ms'
web-1     | Arguments: ()
web-1     | Getting IROs for tenant: tenant1
web-1     | DEBUG: Prepared IRO data for IRO 1: type=Risk, stage=Approved
web-1     | DEBUG: Prepared IRO data for IRO 2: type=Opportunity, stage=Approved
web-1     | DEBUG: Prepared IRO data for IRO 3: type=Impact, stage=Approved
web-1     | DEBUG: Prepared IRO data for IRO 4: type=Risk, stage=Approved
web-1     | DEBUG: Prepared IRO data for IRO 5: type=Opportunity, stage=Approved
web-1     | DEBUG: Prepared IRO data for IRO 6: type=Risk, stage=Approved
web-1     | DEBUG: Prepared IRO data for IRO 7: type=Opportunity, stage=Approved
web-1     | DEBUG: Prepared IRO data for IRO 8: type=Impact, stage=Approved
web-1     | DEBUG: Prepared IRO data for IRO 9: type=Risk, stage=Approved
web-1     | DEBUG: Prepared IRO data for IRO 10: type=Opportunity, stage=Approved
web-1     | INFO 2025-03-06 19:08:59,082 GET /assessments/iro/data/ - 200 in 88.36ms
web-1     | --- Logging error ---
web-1     | Traceback (most recent call last):
web-1     |   File "/usr/local/lib/python3.11/logging/__init__.py", line 449, in format
web-1     |     return self._format(record)
...
web-1     |   File "/app/core/middleware/logging_middleware.py", line 51, in __call__
web-1     |     request_logger.info(log_message, extra={'log_data': log_data})
web-1     | Message: 'GET /assessments/iro/data/ - 200 in 88.36ms'
web-1     | Arguments: ()
web-1     | ERROR 2025-03-06 19:08:59,110 Error loading IRO data: {}
web-1     | INFO 2025-03-06 19:08:59,110 POST /api/logs/frontend/ - 200 in 0.45ms
web-1     | --- Logging error ---
web-1     | Traceback (most recent call last):
web-1     |   File "/usr/local/lib/python3.11/logging/__init__.py", line 449, in format
web-1     |     return self._format(record)
...
web-1     |   File "/app/core/middleware/logging_middleware.py", line 51, in __call__
web-1     |     request_logger.info(log_message, extra={'log_data': log_data})
web-1     | Message: 'POST /api/logs/frontend/ - 200 in 0.45ms'
web-1     | Arguments: ()
</log>
