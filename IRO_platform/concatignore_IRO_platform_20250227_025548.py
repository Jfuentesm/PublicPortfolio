<issue to solve>
in the current context selector, the tenants do not appear as options, only 'default'
...
[+] Running 5/5
 ...
 ✔ Container iro_platform-worker-1  Removed                                                             3.5s 
 ✔ Container iro_platform-db-1      Removed                                                             0.3s 
 ✔ Container iro_platform-redis-1   Removed                                                             0.3s 
...
[+] Building 59.7s (20/24)                                                              docker:desktop-linux
 ...
 => => transferring context: 2B                                                                         0.0s
 => [worker internal] load build context                                                                1.2s
 => => transferring context: 2.92MB                                                                     0.9s
 => [worker 1/8] FROM docker.io/library/python:3.11-slim@sha256:614c8691ab74150465ec9123378cd4dde7a6e5  0.0s
 => => resolve docker.io/library/python:3.11-slim@sha256:614c8691ab74150465ec9123378cd4dde7a6e57be9e55  0.0s
 ...
 => CACHED [worker 4/8] WORKDIR /app                                                                    0.0s
 => [worker 5/8] COPY requirements.txt /app/                                                            0.3s
 => [worker 6/8] RUN pip install --no-cache-dir -r requirements.txt                                    13.8s
 => [worker 7/8] COPY . /app/                                                                           5.0s
 => [web 8/8] RUN chown -R appuser:appuser /app                                                        14.7s
 => [worker] exporting to image                                                                        23.6s
 => => exporting layers                                                                                 8.4s
 => => exporting manifest sha256:c6b1d1bf99c738b1fd26dd4258c205a80865a928d0e9bd1ee2f310618c07b753       0.0s
 => => exporting config sha256:76e0c62ece1964063318736a4ce193237d95af445bdbaf6b50f951b8aa780ca3         0.0s
 => => exporting attestation manifest sha256:e8f31ea60156840ffb02e75e7564974d5b70ffe6cbe50f44e6d24267d  0.0s
 => => exporting manifest list sha256:7960e742e020749e6a9a7e44d96930a97e8b95f5bd9068ecd88213e9df3180b0  0.0s
 => => naming to docker.io/library/iro_platform-worker:latest                                           0.0s
 => => unpacking to docker.io/library/iro_platform-worker:latest                                       15.0s
 => [web] exporting to image                                                                           23.6s
 => => exporting layers                                                                                 8.4s
 => => exporting manifest sha256:1496c1d4229536bbdac18cc228e941ca8a6ab154bd53c91a938d653d01a9cc87       0.0s
 => => exporting config sha256:1d64c710ecbe803cae9f2d53296d21239bed48c60d1988ae8a4ef757a8270ce4         0.0s
 => => exporting attestation manifest sha256:089e0a6a58a3b8b138fbb5d41e2a5fe80ee928769534282e048de7e0e  0.0s
 => => exporting manifest list sha256:9307cf358627a865f4e48b47dfa01dedf2b99cea919c15dd3f4b319563ff873d  0.0s
 => => naming to docker.io/library/iro_platform-web:latest                                              0.0s
 => => unpacking to docker.io/library/iro_platform-web:latest                                          15.0s
...
[+] Running 6/6
 ...
 ✔ Container iro_platform-db-1          Healthy                                                         8.1s 
 ✔ Container iro_platform-redis-1       Healthy                                                         8.1s 
 ✔ Container iro_platform-web-1         Started                                                         7.2s 
 ✔ Container iro_platform-worker-1      Started                                                         7.2s 
...
worker-1  |  
worker-1  |  -------------- celery@1eb4ecfc10b5 v5.2.7 (dawn-chorus)
worker-1  | --- ***** ----- 
worker-1  | -- ******* ---- Linux-6.12.5-linuxkit-aarch64-with-glibc2.36 2025-02-27 07:39:17
worker-1  | - *** --- * --- 
worker-1  | - ** ---------- [config]
worker-1  | - ** ---------- .> app:         core:0xffff832d5a10
...
worker-1  | 
worker-1  | [2025-02-27 07:39:18,182: INFO/MainProcess] Connected to redis://redis:6379/0
worker-1  | [2025-02-27 07:39:18,186: INFO/MainProcess] mingle: searching for neighbors
worker-1  | [2025-02-27 07:39:19,205: INFO/MainProcess] mingle: all alone
worker-1  | [2025-02-27 07:39:19,228: WARNING/MainProcess] /usr/local/lib/python3.11/site-packages/celery/fixups/django.py:203: UserWarning: Using settings.DEBUG leads to a memory
...
worker-1  | 
worker-1  | [2025-02-27 07:39:19,228: INFO/MainProcess] celery@1eb4ecfc10b5 ready.
...
redis-1   | 1:C 27 Feb 2025 07:39:08.971 * oO0OoO0OoO0Oo Redis is starting oO0OoO0OoO0Oo
redis-1   | 1:C 27 Feb 2025 07:39:08.971 * Redis version=7.4.2, bits=64, commit=00000000, modified=0, pid=1, just started
redis-1   | 1:C 27 Feb 2025 07:39:08.971 # Warning: no config file specified, using the default config. In order to specify a config file use redis-server /path/to/redis.conf
redis-1   | 1:M 27 Feb 2025 07:39:08.974 * monotonic clock: POSIX clock_gettime
...
redis-1   | 1:M 27 Feb 2025 07:39:08.981 * Running mode=standalone, port=6379.
redis-1   | 1:M 27 Feb 2025 07:39:08.985 * Server initialized
redis-1   | 1:M 27 Feb 2025 07:39:08.986 * Ready to accept connections tcp
...
db-1      | waiting for server to start....2025-02-27 07:39:10.555 UTC [47] LOG:  starting PostgreSQL 14.17 (Debian 14.17-1.pgdg120+1) on aarch64-unknown-linux-gnu, compiled by gcc (Debian 12.2.0-14) 12.2.0, 64-bit
db-1      | 2025-02-27 07:39:10.557 UTC [47] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
db-1      | 2025-02-27 07:39:10.567 UTC [48] LOG:  database system was shut down at 2025-02-27 07:39:10 UTC
db-1      | 2025-02-27 07:39:10.577 UTC [47] LOG:  database system is ready to accept connections
db-1      |  done
db-1      | server started
...
db-1      | 
db-1      | 
db-1      | waiting for server to shut down...2025-02-27 07:39:10.897 UTC [47] LOG:  received fast shutdown request
db-1      | .2025-02-27 07:39:10.902 UTC [47] LOG:  aborting any active transactions
web-1     |   Applying auth.0001_initial...
db-1      | 2025-02-27 07:39:10.908 UTC [47] LOG:  background worker "logical replication launcher" (PID 54) exited with exit code 1
db-1      | 2025-02-27 07:39:10.908 UTC [49] LOG:  shutting down
db-1      | 2025-02-27 07:39:10.923 UTC [47] LOG:  database system is shut down
web-1     |  OK
...
db-1      | 
db-1      | 2025-02-27 07:39:11.053 UTC [1] LOG:  starting PostgreSQL 14.17 (Debian 14.17-1.pgdg120+1) on aarch64-unknown-linux-gnu, compiled by gcc (Debian 12.2.0-14) 12.2.0, 64-bit
db-1      | 2025-02-27 07:39:11.054 UTC [1] LOG:  listening on IPv4 address "0.0.0.0", port 5432
db-1      | 2025-02-27 07:39:11.054 UTC [1] LOG:  listening on IPv6 address "::", port 5432
db-1      | 2025-02-27 07:39:11.058 UTC [1] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
db-1      | 2025-02-27 07:39:11.063 UTC [64] LOG:  database system was shut down at 2025-02-27 07:39:10 UTC
db-1      | 2025-02-27 07:39:11.070 UTC [1] LOG:  database system is ready to accept connections
...
web-1     | 
web-1     | 
web-1     | 163 static files copied to '/app/core/static', 3 unmodified, 480 post-processed.
web-1     | [2025-02-27 07:39:30 +0000] [29] [INFO] Starting gunicorn 20.1.0
web-1     | [2025-02-27 07:39:30 +0000] [29] [INFO] Listening at: http://0.0.0.0:8000 (29)
web-1     | [2025-02-27 07:39:30 +0000] [29] [INFO] Using worker: sync
web-1     | [2025-02-27 07:39:30 +0000] [30] [INFO] Booting worker with pid: 30
</log>
